...
export function ComboBox({ items, placeholder = "Select an item...", emptyState, onSelect, className, buttonClassName, modal = false, }) {
    ...
    return (<Popover open={open} onOpenChange={setOpen} modal={modal}>
